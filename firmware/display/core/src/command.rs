//! Data shapes and constants for the Display's state-manipulation core. See
//! `docs/architecture.md`'s "Data model" and
...
/// A single tagged value type, not a trait with a method per action —
...
pub struct Command {
    ...
    pub name_left: String,   // StartMatch
